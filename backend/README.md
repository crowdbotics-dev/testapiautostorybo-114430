...
## Project Structure
    ...
    ├── testapiautostorybo_114430  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_114430`
...
2. Clone this repo and `cd testapiautostorybo_114430`
